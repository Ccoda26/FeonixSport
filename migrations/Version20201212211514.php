 ...
 */
final class Version20201212211514 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE program ADD filename_id INT DEFAULT NULL, DROP content');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE program ADD content VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP filename_id');
    }
}
