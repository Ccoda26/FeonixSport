 ...
 */
final class Version20201202142938 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE media DROP FOREIGN KEY FK_6A2CA10CE934951A');
        $this->addSql('DROP INDEX IDX_6A2CA10CE934951A ON media');
        $this->addSql('DROP INDEX IDX_6A2CA10C7294869C ON media');
        $this->addSql('DROP INDEX IDX_6A2CA10C3EB8070A ON media');
        $this->addSql('ALTER TABLE media DROP article_id, DROP exercise_id, DROP program_id');
    }

    public function down(Schema $schema) : void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE media ADD article_id INT DEFAULT NULL, ADD exercise_id INT DEFAULT NULL, ADD program_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE media ADD CONSTRAINT FK_6A2CA10CE934951A FOREIGN KEY (exercise_id) REFERENCES exercise (id)');
        $this->addSql('CREATE INDEX IDX_6A2CA10CE934951A ON media (exercise_id)');
